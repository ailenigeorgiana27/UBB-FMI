...
PRINT 'S-a adaugat constrangere pentru coloana [Cantitate] din tabelul [Produse]'
GO
...
PRINT 'S-a eliminat constrangerea pentru coloana [Cantitate] din tabelul [Produse]'
GO
...
PRINT 'S-a eliminat coloana[Data_comanda] din tabelul [ComenziFinalizate]'
GO
...
PRINT 'S-a eliminat cheia straina din tabelul [ComenziFinalizate]'
GO
